...
-- rank restaurants based on their average cost for two people within each city:
...
-- Top-rated restaurant in each city:
...
-- Top-Voted restaurant in each city with there respective rating:
